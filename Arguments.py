...
parser.add_argument('--epochs', default = 25, type = int, metavar = 'N',#20
                    help = 'number of total epochs to run')
parser.add_argument('--start_epoch', default = 0, type = int, metavar = 'N',
                    help = 'manual epoch number (useful on restarts)')
parser.add_argument('-b', '--batch_size', default = 4, type = int,
                    metavar = 'N', help = 'mini-batch size (default: 128)')
parser.add_argument('--lr', '--learning_rate', default = 0.0001 , type = float,   #lr=1.30208333333e-07
...
parser.add_argument('--test_list', default = './SaliconDataset/valList.txt', type = str, metavar
= 'PATH',
                    help = 'path to validation list (default: none)')
parser.add_argument('--save_path', default = './Models/Model_Save_new/SalDA/', type = str, metavar = 'PATH',
                    help = 'path to save checkpoint (default: none)')
parser.add_argument('--model', default = 'SalDA', type = str, metavar = 'Model',
                    help = 'model type: SalDA')
